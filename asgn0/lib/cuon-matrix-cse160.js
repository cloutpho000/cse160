...
class Vector3 {
    ...
    add(other) {
        ...
        let x = this.elements[0] + other.elements[0];
        let y = this.elements[1] + other.elements[1];
        let z = this.elements[2] + other.elements[2];
    ...
    div(scalar) {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        let x = this.elements[0] / scalar;
        let y = this.elements[1] / scalar;
        let z = this.elements[2] / scalar;
        this.elements[0] = x;
        this.elements[1] = y;
        this.elements[2] = z;
        // Don't delete the return statement.
    ...
    magnitude() {
        // Insert your code here.
        let xsq = this.elements[0] * this.elements[0];
        let ysq = this.elements[1] * this.elements[1];
        let zsq = this.elements[2] * this.elements[2];
        let m = Math.sqrt(xsq + ysq + zsq);
        // Don't delete the return statement.
        return m;
    };
    ...
    normalize() {
        ...
        let x = this.elements[0] / m;
        let y = this.elements[1] / m;
        let z = this.elements[2] / m;
        let newvector = new Vector3([x, y, z]);
        // Don't delete the return statement.
        return newvector;
    };
